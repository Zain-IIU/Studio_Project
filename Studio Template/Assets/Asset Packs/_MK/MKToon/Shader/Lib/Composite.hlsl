...
//////////////////////////////////////////////////////
	...
	inline void Composite(inout Surface surface, in MKSurfaceData surfaceData, in MKPBSData pbsData)
	{
				...
				AmbientOcclusionFactor aoFactor = GetScreenSpaceAmbientOcclusion(surfaceData.screenUV.xy);
				surface.direct.rgb *= aoFactor.directAmbientOcclusion;
				#if defined(MK_INDIRECT)
					surface.indirect.rgb *= aoFactor.indirectAmbientOcclusion;
				#endif
			#endif
